...
import testClassPack.Post_TC_2;
...
public class Post_TC_2 {
	...
	public static void execute() throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			int statusCode = API_Common_Function.Response_statusCode(Post_req_repository.Base_URI(),
					Post_req_repository.Post_TC2(), Post_req_repository.Post_Resource());
			...
			if (statusCode == 201) {
				...
				Utility_Common_Function.Evidence_File_Creator("Post_TC_2", Post_req_repository.Post_TC2(),
						responseBody);
				break;
	...
	public static void validator(String responseBody, int statusCode) throws IOException {
		...
		JsonPath jspreq = new JsonPath(Post_req_repository.Post_TC2());
